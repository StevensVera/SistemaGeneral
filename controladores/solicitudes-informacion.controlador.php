<?php
                        ...
                        if($_POST["nuevoSI_Total"] == $_POST["nuevoSI_MR_Suma_Total"]){
                          ...
                          if($_POST["nuevoSI_Total"] == $_POST["nuevoSI_OS_Suma_Total"]){
                            ...
                            if($_POST["nuevoSI_Total"] == $_POST["nuevoSI_SR_Suma_Total"]){
                                ...
                                $respuesta = ModeloSolicitudesInformacion::MdlAgregarSI_r($tablaSI_r, $datos);
  ...
  /* ================  EDITAR - LOS DATOS REGISTRADOS - DESDE LA UNIDAD DE TRANSPARENCIA   ================= */ 
   ...
   static public function ctrActualizarSolicitudInformacion(){
    ...
    /* =========== ELIMINAR - SOLICITUDES DE INFORMACION - DESDE LA UNIDAD DE TRANSPARENCIA - TABLA PRINCIPAL - ================ */  
     ...
     static public function ctrBorrarRegistroSolicitudInformacion(){
      ...
      if(isset($_GET["idSI"])){
        ...
        /* =========== ELIMINAR - SOLICITUDES DE INFORMACION - DESDE LA UNIDAD DE TRANSPARENCIA - TABLA SECUNDARIA - ================ */  

     static public function ctrBorrarRegistroSolicitudInformacion_r(){

      if(isset($_GET["idSI"])){

        $tabla ="solicitudes_informacion_r";

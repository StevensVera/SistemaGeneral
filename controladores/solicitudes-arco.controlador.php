    ...
    /* =========== MOSTRAR DATOS TABLA - SOLICITUDES DE INFORMACION - DESDE LA UNIDAD DE TRANSPARENCIA ================ */
        ...
        static public function ctrAgregarSolicitudesArco(){
            ...
            if (isset($_POST["nuevoAnioSA"])) {
              ...
              if($_POST["nuevoSA_Total"] == $_POST["nuevoSA_MP_Suma_Total"]){

                // TIPO DE SOLICITANTE
                
                if($_POST["nuevoSA_Total"] == $_POST["nuevoSA_TS_Suma_Total"]){

                  // GENERO DEL SOLICITANTE
                
                  if($_POST["nuevoSA_Total"] == $_POST["nuevoSA_GS_Suma_Total"]){

                    // INFORMACIÓN SOLICITADA
                
                    if($_POST["nuevoSA_Total"] == $_POST["nuevoSA_IS_Suma_Total"]){

                      // TRAMITES
                
                      if($_POST["nuevoSA_Total"] == $_POST["nuevoSA_T_Suma_Total"]){

                        // MODALIDAD DE RESPUESTA
                
                        if($_POST["nuevoSA_Total"] == $_POST["nuevoSA_MR_Suma_Total"]){

                            // SENTIDO EN QUE SE EMITE LA RESPUESTA
                
                            if($_POST["nuevoSA_Total"] == $_POST["nuevoSA_SR_Suma_Total"]){
      ...
      /* ================  EDITAR - LOS DATOS REGISTRADOS - DESDE LA UNIDAD DE TRANSPARENCIA   ================= */ 
        ...
        static public function ctrActualizarSolicitudArco2(){
         ...
         if (isset($_POST["EditarAnioSolicitudesArco"])) {
              ...
              if($_POST["EditarSolicitudesArco_Total"] == $_POST["EditarSolicitudesArco_MP_Suma_Total"]){

                // TIPO DE SOLICITANTE
                
                if($_POST["EditarSolicitudesArco_Total"] == $_POST["EditarSolicitudesArco_TS_Suma_Total"]){

                  // GENERO DEL SOLICITANTE
                
                  if($_POST["EditarSolicitudesArco_Total"] == $_POST["EditarSolicitudesArco_GS_Suma_Total"]){

                    // INFORMACIÓN SOLICITADA
                
                    if($_POST["EditarSolicitudesArco_Total"] == $_POST["EditarSolicitudesArco_IS_Suma_Total"]){

                      // TRAMITES
                
                      if($_POST["EditarSolicitudesArco_Total"] == $_POST["EditarSolicitudesArco_T_Suma_Total"]){

                        // MODALIDAD DE RESPUESTA
                
                        if($_POST["EditarSolicitudesArco_Total"] == $_POST["EditarSolicitudesArco_MR_Suma_Total"]){

                            // SENTIDO EN QUE SE EMITE LA RESPUESTA
                
                            if($_POST["EditarSolicitudesArco_Total"] == $_POST["EditarSolicitudesArco_SR_Suma_Total"]){

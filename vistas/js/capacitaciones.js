  ...
  $.ajax({
    ...
    dataType:"json",
      success: function(respuesta){
        ...
        // OBSERVACIONES
        $("#MostrarObservacionesSOCA").val(respuesta["CA_Observaciones_General"]);
        $("#MostrarArchivoObservacionesSOCA").attr("src", respuesta["CA_Observaciones_Generales"]);

        // REQUERIMIENTOS AMONESTACIÓN PRIVADA
        $("#MostrarAmonestacionPrivadasSOCA").val(respuesta["CA_Observaciones"]);
        $("#MostrarArchivoAmonestacionPrivadaSOCA").attr("src", respuesta["CA_Requerimiento_Amonestacion_Privada"]);

        // REQUERIMIENTOS AMONESTACIÓN PUBLICA
        $("#MostrarAmonestacionPublicaSOCA").val(respuesta["CA_Observaciones_Publica"]);
        $("#MostrarArchivoAmonestacionPublicaSOCA").attr("src", respuesta["CA_Requerimiento_Amonestacion_Publica"]);

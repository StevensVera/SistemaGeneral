...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-10-2021 a las 00:56:52
...
CREATE TABLE `solicitudes_arco` (
  ...
  `SA_Anios` int(11) NOT NULL DEFAULT 0,
  `SA_Fecha` timestamp NOT NULL DEFAULT current_timestamp(),
  `SA_TOTAL_SOLICITUDES` int(11) DEFAULT NULL,
  `SA_Medio_Presentacion_Personal-Escrito` int(11) DEFAULT NULL,
  `SA_Medio_Presentacion_Correo-Electronico` int(11) DEFAULT NULL,
  `SA_Medio_Presentacion_Sistema-Infomex` int(11) DEFAULT NULL,
  `SA_Medio_Presentacion_PNT` int(11) DEFAULT NULL,
  `SA_Medio_Presentacion_No disponible` int(11) DEFAULT NULL,
  `SA_Medio_Presentacion_Suma-Total` int(11) DEFAULT NULL,
  `SA_Tipo_Solicitante_Persona-Fisica` int(11) DEFAULT NULL,
  `SA_Tipo_Solicitante_Persona-Moral` int(11) DEFAULT NULL,
  `SA_Tipo_Solicitante_No-Disponible` int(11) DEFAULT NULL,
  `SA_Tipo_Solicitante_Suma-Total` int(11) DEFAULT NULL,
  ...
  `SA_Genero_Solicitante_No-Disponible` int(11) DEFAULT NULL,
  `SA_Genero_Solicitante_Suma-Total` int(11) DEFAULT NULL,
  ...
  `SA_Informacion_Solicitada_No-Disponible` int(11) DEFAULT NULL,
  `SA_Informacion_Solicitada_Suma-Total` int(11) DEFAULT NULL,
  `SA_Tramites_Concluidas` int(11) DEFAULT NULL,
  `SA_Tramites_Pendientes` int(11) DEFAULT NULL,
  `SA_Tramites_No-Disponible` int(11) DEFAULT NULL,
  `SA_Tramites_Suma-Total` int(11) DEFAULT NULL,
  `SA_Modalidad_Respuesta_Medios-Electronicos` int(11) DEFAULT NULL,
  `SA_Modalidad_Respuesta_Copia-Simple` int(11) DEFAULT NULL,
  `SA_Modalidad_Respuesta_Consulta-Directa` int(11) DEFAULT NULL,
  `SA_Modalidad_Respuesta_Copia-Certificada` int(11) DEFAULT NULL,
  `SA_Modalidad_Respuesta_Otro` int(11) DEFAULT NULL,
  `SA_Modalidad_Respuesta_No-Disponible` int(11) DEFAULT NULL,
  `SA_Modalidad_Respuesta_Suma-Total` int(11) DEFAULT NULL,
  `SA_Sentido_Respuesta_Informacion` int(11) DEFAULT NULL,
  `SA_Sentido_Respuesta_Informacion-Parcial` int(11) DEFAULT NULL,
  `SA_Sentido_Respuesta_Negada-Clasificacion` int(11) DEFAULT NULL,
  `SA_Sentido_Respuesta_Inexistencia-Informacion` int(11) DEFAULT NULL,
  `SA_Sentido_Respuesta_Mixta` int(11) DEFAULT NULL,
  `SA_Sentido_Respuesta_No-Acalarada` int(11) DEFAULT NULL,
  `SA_Sentido_Respuesta_Orientada` int(11) DEFAULT NULL,
  `SA_Sentido_Respuesta_En-Tramite` int(11) DEFAULT NULL,
  `SA_Sentido_Respuesta_Improcedente` int(11) DEFAULT NULL,
  `SA_Sentido_Respuesta_Otros` int(11) DEFAULT NULL,
  `SA_Sentido_Respuesta_Suma-Total` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci ROW_FORMAT=DYNAMIC;
...
INSERT INTO `solicitudes_arco` (`idSAR`, `SA_Codigo_Informe_Anios`, `SA_Nombre_Sujeto_Obligado`, `SA_Informe_Presentado`, `SA_Anios`, `SA_Fecha`, `SA_TOTAL_SOLICITUDES`, `SA_Medio_Presentacion_Personal-Escrito`, `SA_Medio_Presentacion_Correo-Electronico`, `SA_Medio_Presentacion_Sistema-Infomex`, `SA_Medio_Presentacion_PNT`, `SA_Medio_Presentacion_No disponible`, `SA_Medio_Presentacion_Suma-Total`, `SA_Tipo_Solicitante_Persona-Fisica`, `SA_Tipo_Solicitante_Persona-Moral`, `SA_Tipo_Solicitante_No-Disponible`, `SA_Tipo_Solicitante_Suma-Total`, `SA_Genero_Solicitante_Femenino`, `SA_Genero_Solicitante_Masculino`, `SA_Genero_Solicitante_Anonimo`, `SA_Genero_Solicitante_No-Disponible`, `SA_Genero_Solicitante_Suma-Total`, `SA_Informacion_Solicitada_Acceso`, `SA_Informacion_Solicitada_Rectificacion`, `SA_Informacion_Solicitada_Oposicion`, `SA_Informacion_Solicitada_Cancelacion`, `SA_Informacion_Solicitada_Otro`, `SA_Informacion_Solicitada_No-Disponible`, `SA_Informacion_Solicitada_Suma-Total`, `SA_Tramites_Concluidas`, `SA_Tramites_Pendientes`, `SA_Tramites_No-Disponible`, `SA_Tramites_Suma-Total`, `SA_Modalidad_Respuesta_Medios-Electronicos`, `SA_Modalidad_Respuesta_Copia-Simple`, `SA_Modalidad_Respuesta_Consulta-Directa`, `SA_Modalidad_Respuesta_Copia-Certificada`, `SA_Modalidad_Respuesta_Otro`, `SA_Modalidad_Respuesta_No-Disponible`, `SA_Modalidad_Respuesta_Suma-Total`, `SA_Sentido_Respuesta_Informacion`, `SA_Sentido_Respuesta_Informacion-Parcial`, `SA_Sentido_Respuesta_Negada-Clasificacion`, `SA_Sentido_Respuesta_Inexistencia-Informacion`, `SA_Sentido_Respuesta_Mixta`, `SA_Sentido_Respuesta_No-Acalarada`, `SA_Sentido_Respuesta_Orientada`, `SA_Sentido_Respuesta_En-Tramite`, `SA_Sentido_Respuesta_Improcedente`, `SA_Sentido_Respuesta_Otros`, `SA_Sentido_Respuesta_Suma-Total`) VALUES
(7, '3er Informe Bimestral 2021', 'H. Ayuntamiento de Acaponeta', '4to Informe Bimestral', 2021, '2021-08-23 19:43:42', 5, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
CREATE TABLE `solicitudes_informacion` (
  ...
  `SI_Anios` int(11) NOT NULL,
  `SI_Fecha` timestamp NOT NULL DEFAULT current_timestamp(),
  `SI_TOTAL_SOLICITUDES` int(11) DEFAULT NULL,
  `SI_Medio_Presentacion_Personal-Escrito` int(11) DEFAULT NULL,
  `SI_Medio_Presentacion_Correo-Electronico` int(11) DEFAULT NULL,
  `SI_Medio_Presentacion_Sistema-Infomex` int(11) DEFAULT NULL,
  `SI_Medio_Presentacion_PNT` int(11) DEFAULT NULL,
  `SI_Medio_Presentacion_No-disponible` int(11) DEFAULT NULL,
  `SI_Medio_Presentacion_Suma-Total` int(11) DEFAULT NULL,
  `SI_Tipo_Solicitud_Persona-Fisica` int(11) DEFAULT NULL,
  `SI_Tipo_Solicitud_Persona-Moral` int(11) DEFAULT NULL,
  `SI_Tipo_Solicitud_No-Disponible` int(11) DEFAULT NULL,
  `SI_Tipo_Solicitud_Suma-Total` int(11) DEFAULT NULL,
  ...
  `SI_Genero_Solicitante_No-Disponible` int(11) DEFAULT NULL,
  `SI_Genero_Solicitante_Suma-Total` int(11) DEFAULT NULL,
  `SI_Informacion_Solicitada_Obligacion-Transparencia` int(11) DEFAULT NULL,
  ...
  `SI_Informacion_Solicitada_No-Disponible` int(11) DEFAULT NULL,
  `SI_Informacion_Solicitada_Suma-Total` int(11) DEFAULT NULL,
  `SI_Tramites_Concluidas` int(11) DEFAULT NULL,
  `SI_Tramites_Pendientes` int(11) DEFAULT NULL,
  `SI_Tramites_No-Disponible` int(11) DEFAULT NULL,
  `SI_Tramites_Suma-Total` int(11) DEFAULT NULL,
  `SI_Modalidad_Respuesta_Medios-Electronicos` int(11) DEFAULT NULL,
  `SI_Modalidad_Respuesta_Copia-Simple` int(11) DEFAULT NULL,
  `SI_Modalidad_Respuesta_Consulta-Directa` int(11) DEFAULT NULL,
  `SI_Modalidad_Respuesta_Copia-Certificada` int(11) DEFAULT NULL,
  `SI_Modalidad_Respuesta_Otro` int(11) DEFAULT NULL,
  `SI_Modalidad_Respuesta_No-Disponible` int(11) DEFAULT NULL,
  `SI_Modalidad_Respuesta_Suma-Total` int(11) DEFAULT NULL,
  `SI_Obligaciones_Solicitadas_Marco-Normativo` int(11) DEFAULT NULL,
  `SI_Obligaciones_Solicitadas_Estructura-Organica` int(11) DEFAULT NULL,
  `SI_Obligaciones_Solicitadas_Funciones-Area` int(11) DEFAULT NULL,
  `SI_Obligaciones_Solicitadas_Metas-Objetivos` int(11) DEFAULT NULL,
  `SI_Obligaciones_Solicitadas_Indicadores-Relacionados` int(11) DEFAULT NULL,
  `SI_Obligaciones_Solicitadas_Indicadores-Rendir-Cuentas` int(11) DEFAULT NULL,
  `SI_Obligaciones_Solicitadas_Directorio-Servidor-Publico` int(11) DEFAULT NULL,
  `SI_Obligaciones_Solicitadas_Remuneraciones-Personal` int(11) DEFAULT NULL,
  `SI_Obligaciones_Solicitadas_Gasto-Representacion-Viaticos` int(11) DEFAULT NULL,
  `SI_Obligaciones_Solicitadas-Plazas-Bases-Confianza-Vacantes` int(11) DEFAULT NULL,
  `SI_Obligaciones_Solicitadas-Contratacion_Servicios` int(11) DEFAULT NULL,
  `SI_Obligaciones_Solicitadas-Versiones-Publicas` int(11) DEFAULT NULL,
  `SI_Obligaciones_Solicitadas-Domicilio-Direccion-UT` int(11) DEFAULT NULL,
  `SI_Obligaciones_Solicitadas-Convocatoria-Concurso-Cargo` int(11) DEFAULT NULL,
  `SI_Obligaciones_Solicitadas-Informacion-Programas-Subsidios` int(11) DEFAULT NULL,
  `SI_Obligaciones_Solicitadas-Condiciones-Trabajos` int(11) DEFAULT NULL,
  `SI_Obligaciones_Solicitadas-Recursos-Publicos` int(11) DEFAULT NULL,
  `SI_Obligaciones_Solicitadas-Informacion-Curricular` int(11) DEFAULT NULL,
  `SI_Obligaciones_Solicitadas_Servidores-Publicos-Sancionados` int(11) DEFAULT NULL,
  `SI_Obligaciones_Solicitadas_Servicios-Ofrecen` int(11) DEFAULT NULL,
  `SI_Obligaciones_Solicitadas_Tramites-Requisitos-Formatos` int(11) DEFAULT NULL,
  `SI_Obligaciones_Solicitadas_Presupuesto-Asignado` int(11) DEFAULT NULL,
  `SI_Obligaciones_Solicitadas_Informacion-Relativa` int(11) DEFAULT NULL,
  `SI_Obligaciones_Solicitadas_Montos-Designados` int(11) DEFAULT NULL,
  `SI_Obligaciones_Solicitadas_Informes-Resultados-Auditorias` int(11) DEFAULT NULL,
  `SI_Obligaciones_Solicitadas_Resultados-Dictaminacion` int(11) DEFAULT NULL,
  `SI_Obligaciones_Solicitadas_Montos-Criterios-Convocatorias` int(11) DEFAULT NULL,
  `SI_Obligaciones_Solicitadas_Concesiones-Contratos-Convenios` int(11) DEFAULT NULL,
  `SI_Obligaciones_Solicitadas_Resultados-Procesos-Adjudicaciones` int(11) DEFAULT NULL,
  `SI_Obligaciones_Solicitadas_Infomes-Generen-SO` int(11) DEFAULT NULL,
  `SI_Obligaciones_Solicitadas_Estadisticas-Generan-Cumplimiento` int(11) DEFAULT NULL,
  `SI_Obligaciones_Solicitadas_Avances-Programaticos` int(11) DEFAULT NULL,
  `SI_Obligaciones_Solicitadas_Padron-Proveedores` int(11) DEFAULT NULL,
  `SI_Obligaciones_Solicitadas_Convenios-Coordinacion` int(11) DEFAULT NULL,
  `SI_Obligaciones_Solicitadas_Inventario-Muebles-Inmuebles` int(11) DEFAULT NULL,
  `SI_Obligaciones_Solicitadas_Recomendaciones_Emitidas` int(11) DEFAULT NULL,
  `SI_Obligaciones_Solicitadas_Resoluciones-Laudos` int(11) DEFAULT NULL,
  `SI_Obligaciones_Solicitadas_Mecanismo_Participacion` int(11) DEFAULT NULL,
  `SI_Obligaciones_Solicitadas_Programas-Ofrecidos` int(11) DEFAULT NULL,
  `SI_Obligaciones_Solicitadas-Actas-Resoluciones` int(11) DEFAULT NULL,
  `SI_Obligaciones_Solicitadas_Evaluaciones-Encuestas` int(11) DEFAULT NULL,
  `SI_Obligaciones_Solicitadas_Estudios-Financiados` int(11) DEFAULT NULL,
  `SI_Obligaciones_Solicitadas_Listado-Jubilados-Pensionados` int(11) DEFAULT NULL,
  `SI_Obligaciones_Solicitadas_Ingreso_Recibido` int(11) DEFAULT NULL,
  `SI_Obligaciones_Solicitadas_Donaciones-Hechas` int(11) DEFAULT NULL,
  `SI_Obligaciones_Solicitadas_Catalogos-Disposicion` int(11) DEFAULT NULL,
  `SI_Obligaciones_Solicitadas_Actas-Sesiones-Ordinarias` int(11) DEFAULT NULL,
  `SI_Obligaciones_Solicitadas_Listados-Solicitudes-Proveedores` int(11) DEFAULT NULL,
  `SI_Obligaciones_Solicitadas_Gacetas-Municipales` int(11) DEFAULT NULL,
  `SI_Obligaciones_Solicitadas_Plan-Desarrollo-Municipal` int(11) DEFAULT NULL,
  `SI_Obligaciones_Solicitadas-Presupuestos-Egresos` int(11) DEFAULT NULL,
  `SI_Obligaciones_Solicitadas-Plan-Desarrollo-Urbano` int(11) DEFAULT NULL,
  `SI_Obligaciones_Solicitadas-Programa-Ordenamiento` int(11) DEFAULT NULL,
  `SI_Obligaciones_Solicitadas_Programa-Uso-Suelo` int(11) DEFAULT NULL,
  `SI_Obligaciones_Solicitadas_Tipos_Uso-Suelo` int(11) DEFAULT NULL,
  `SI_Obligaciones_Solicitadas_Licencia_Uso-Suelo` int(11) DEFAULT NULL,
  `SI_Obligaciones_Solicitadas_Licencias-Construccion` int(11) DEFAULT NULL,
  `SI_Obligaciones_Solicitadas_Actas-Cabildo` int(11) DEFAULT NULL,
  `SI_Obligaciones_Solicitadas_Prosupuesto-Sostenible` int(11) DEFAULT NULL,
  `SI_Obligaciones_Solicitadas_Evaluaciones-LDF` int(11) DEFAULT NULL,
  `SI_Obligaciones_Solicitadas_Subsidios` int(11) DEFAULT NULL,
  `SI_Obligaciones_Solicitadas_Otros` int(11) DEFAULT NULL,
  `SI_Obligaciones_Solicitadas_No-Disponibles` int(11) DEFAULT NULL,
  `SI_Obligaciones_Solicitadas_Suma-Total` int(11) DEFAULT NULL,
  `SI_Sentido_Respuesta_Informacion` int(11) DEFAULT NULL,
  `SI_Sentido_Respuesta_Informacion-Parcial` int(11) DEFAULT NULL,
  `SI_Sentido_Respuesta_Negada-Clasificacion` int(11) DEFAULT NULL,
  `SI_Sentido_Respuesta_Inexistencia-Informacion` int(11) DEFAULT NULL,
  `SI_Sentido_Respuesta_Mixta` int(11) DEFAULT NULL,
  `SI_Sentido_Respuesta_No-Aclarada` int(11) DEFAULT NULL,
  `SI_Sentido_Respuesta_Orientada` int(11) DEFAULT NULL,
  `SI_Sentido_Respuesta_En-Tramite` int(11) DEFAULT NULL,
  `SI_Sentido_Respuesta_Improcedente` int(11) DEFAULT NULL,
  `SI_Sentido_Respuesta_Otro` int(11) DEFAULT NULL,
  `SI_Sentido_Respuesta_No-Disponible` int(11) DEFAULT NULL,
  `SI_Sentido_Respuesta_Suma-Total` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci ROW_FORMAT=DYNAMIC;
...
INSERT INTO `solicitudes_informacion` (`idSI`, `SI_Codigo_SO`, `Si_Codigo_Informe_Anios`, `SI_Nombre_Sujeto_Obligado`, `SI_Informe_Presentado`, `SI_Anios`, `SI_Fecha`, `SI_TOTAL_SOLICITUDES`, `SI_Medio_Presentacion_Personal-Escrito`, `SI_Medio_Presentacion_Correo-Electronico`, `SI_Medio_Presentacion_Sistema-Infomex`, `SI_Medio_Presentacion_PNT`, `SI_Medio_Presentacion_No-disponible`, `SI_Medio_Presentacion_Suma-Total`, `SI_Tipo_Solicitud_Persona-Fisica`, `SI_Tipo_Solicitud_Persona-Moral`, `SI_Tipo_Solicitud_No-Disponible`, `SI_Tipo_Solicitud_Suma-Total`, `SI_Genero_Solicitante_Femenino`, `SI_Genero_Solicitante_Masculino`, `SI_Genero_Solicitante_Anonimo`, `SI_Genero_Solicitante_No-Disponible`, `SI_Genero_Solicitante_Suma-Total`, `SI_Informacion_Solicitada_Obligacion-Transparencia`, `SI_Informacion_Solicitada_Reservada`, `SI_Informacion_Solicitada_Confidencial`, `SI_Informacion_Solicitada_Otro`, `SI_Informacion_Solicitada_No-Disponible`, `SI_Informacion_Solicitada_Suma-Total`, `SI_Tramites_Concluidas`, `SI_Tramites_Pendientes`, `SI_Tramites_No-Disponible`, `SI_Tramites_Suma-Total`, `SI_Modalidad_Respuesta_Medios-Electronicos`, `SI_Modalidad_Respuesta_Copia-Simple`, `SI_Modalidad_Respuesta_Consulta-Directa`, `SI_Modalidad_Respuesta_Copia-Certificada`, `SI_Modalidad_Respuesta_Otro`, `SI_Modalidad_Respuesta_No-Disponible`, `SI_Modalidad_Respuesta_Suma-Total`, `SI_Obligaciones_Solicitadas_Marco-Normativo`, `SI_Obligaciones_Solicitadas_Estructura-Organica`, `SI_Obligaciones_Solicitadas_Funciones-Area`, `SI_Obligaciones_Solicitadas_Metas-Objetivos`, `SI_Obligaciones_Solicitadas_Indicadores-Relacionados`, `SI_Obligaciones_Solicitadas_Indicadores-Rendir-Cuentas`, `SI_Obligaciones_Solicitadas_Directorio-Servidor-Publico`, `SI_Obligaciones_Solicitadas_Remuneraciones-Personal`, `SI_Obligaciones_Solicitadas_Gasto-Representacion-Viaticos`, `SI_Obligaciones_Solicitadas-Plazas-Bases-Confianza-Vacantes`, `SI_Obligaciones_Solicitadas-Contratacion_Servicios`, `SI_Obligaciones_Solicitadas-Versiones-Publicas`, `SI_Obligaciones_Solicitadas-Domicilio-Direccion-UT`, `SI_Obligaciones_Solicitadas-Convocatoria-Concurso-Cargo`, `SI_Obligaciones_Solicitadas-Informacion-Programas-Subsidios`, `SI_Obligaciones_Solicitadas-Condiciones-Trabajos`, `SI_Obligaciones_Solicitadas-Recursos-Publicos`, `SI_Obligaciones_Solicitadas-Informacion-Curricular`, `SI_Obligaciones_Solicitadas_Servidores-Publicos-Sancionados`, `SI_Obligaciones_Solicitadas_Servicios-Ofrecen`, `SI_Obligaciones_Solicitadas_Tramites-Requisitos-Formatos`, `SI_Obligaciones_Solicitadas_Presupuesto-Asignado`, `SI_Obligaciones_Solicitadas_Informacion-Relativa`, `SI_Obligaciones_Solicitadas_Montos-Designados`, `SI_Obligaciones_Solicitadas_Informes-Resultados-Auditorias`, `SI_Obligaciones_Solicitadas_Resultados-Dictaminacion`, `SI_Obligaciones_Solicitadas_Montos-Criterios-Convocatorias`, `SI_Obligaciones_Solicitadas_Concesiones-Contratos-Convenios`, `SI_Obligaciones_Solicitadas_Resultados-Procesos-Adjudicaciones`, `SI_Obligaciones_Solicitadas_Infomes-Generen-SO`, `SI_Obligaciones_Solicitadas_Estadisticas-Generan-Cumplimiento`, `SI_Obligaciones_Solicitadas_Avances-Programaticos`, `SI_Obligaciones_Solicitadas_Padron-Proveedores`, `SI_Obligaciones_Solicitadas_Convenios-Coordinacion`, `SI_Obligaciones_Solicitadas_Inventario-Muebles-Inmuebles`, `SI_Obligaciones_Solicitadas_Recomendaciones_Emitidas`, `SI_Obligaciones_Solicitadas_Resoluciones-Laudos`, `SI_Obligaciones_Solicitadas_Mecanismo_Participacion`, `SI_Obligaciones_Solicitadas_Programas-Ofrecidos`, `SI_Obligaciones_Solicitadas-Actas-Resoluciones`, `SI_Obligaciones_Solicitadas_Evaluaciones-Encuestas`, `SI_Obligaciones_Solicitadas_Estudios-Financiados`, `SI_Obligaciones_Solicitadas_Listado-Jubilados-Pensionados`, `SI_Obligaciones_Solicitadas_Ingreso_Recibido`, `SI_Obligaciones_Solicitadas_Donaciones-Hechas`, `SI_Obligaciones_Solicitadas_Catalogos-Disposicion`, `SI_Obligaciones_Solicitadas_Actas-Sesiones-Ordinarias`, `SI_Obligaciones_Solicitadas_Listados-Solicitudes-Proveedores`, `SI_Obligaciones_Solicitadas_Gacetas-Municipales`, `SI_Obligaciones_Solicitadas_Plan-Desarrollo-Municipal`, `SI_Obligaciones_Solicitadas-Presupuestos-Egresos`, `SI_Obligaciones_Solicitadas-Plan-Desarrollo-Urbano`, `SI_Obligaciones_Solicitadas-Programa-Ordenamiento`, `SI_Obligaciones_Solicitadas_Programa-Uso-Suelo`, `SI_Obligaciones_Solicitadas_Tipos_Uso-Suelo`, `SI_Obligaciones_Solicitadas_Licencia_Uso-Suelo`, `SI_Obligaciones_Solicitadas_Licencias-Construccion`, `SI_Obligaciones_Solicitadas_Actas-Cabildo`, `SI_Obligaciones_Solicitadas_Prosupuesto-Sostenible`, `SI_Obligaciones_Solicitadas_Evaluaciones-LDF`, `SI_Obligaciones_Solicitadas_Subsidios`, `SI_Obligaciones_Solicitadas_Otros`, `SI_Obligaciones_Solicitadas_No-Disponibles`, `SI_Obligaciones_Solicitadas_Suma-Total`, `SI_Sentido_Respuesta_Informacion`, `SI_Sentido_Respuesta_Informacion-Parcial`, `SI_Sentido_Respuesta_Negada-Clasificacion`, `SI_Sentido_Respuesta_Inexistencia-Informacion`, `SI_Sentido_Respuesta_Mixta`, `SI_Sentido_Respuesta_No-Aclarada`, `SI_Sentido_Respuesta_Orientada`, `SI_Sentido_Respuesta_En-Tramite`, `SI_Sentido_Respuesta_Improcedente`, `SI_Sentido_Respuesta_Otro`, `SI_Sentido_Respuesta_No-Disponible`, `SI_Sentido_Respuesta_Suma-Total`) VALUES
(13, 'A.1', '3er Informe Bimestral 2021', 'H. Ayuntamiento de Acaponeta', '3er Informe Bimestral', 2021, '2021-07-17 22:10:15', 5, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(15, 'A.2', '4to Informe Bimestral 2021', 'H. Ayuntamiento de Ahuacatlán', '4to Informe Bimestral', 2021, '2021-08-17 19:11:43', 19, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
--
ALTER TABLE `solicitudes_arco`
  MODIFY `idSAR` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT de la tabla `solicitudes_informacion`
--
ALTER TABLE `solicitudes_informacion`
  MODIFY `idSI` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
